...
export const EmptyState: React.FC = () => {
  return (
    <div className="min-h-screen bg-talpa-bg flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <div className="space-y-3">
          <h1 className="text-xl font-mono font-bold text-talpa-gold tracking-widest uppercase">
            NO ACTIVE SORTIES
          </h1>
          <div className="flex items-center justify-center gap-2 text-talpa-primary">
            <Radio className="w-4 h-4" />
            <p className="text-sm font-medium">RADAR CLEAR</p>
          </div>
          <p className="text-sm text-talpa-primary/70 mt-4 max-w-xs mx-auto leading-relaxed">
            Şu anda planlanmış aktif bir etkinlik veya uçuş bulunmamaktadır. Lütfen daha sonra tekrar kontrol ediniz.
          </p>
        </div>

        {/* Status Indicator */}
        <div className="mt-10 inline-flex items-center gap-2 px-4 py-2 bg-talpa-primary/10 border border-talpa-primary/20 rounded-md">
          <div className="w-2 h-2 bg-talpa-red rounded-full"></div>
          <span className="text-xs font-mono font-semibold text-talpa-primary">SYSTEM STANDBY</span>
        </div>
